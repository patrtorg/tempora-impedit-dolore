<h1><p align="center"><img alt="protobuf.js" src="https://github.com/patrtorg/tempora-impedit-dolore/raw/master/pbjs.svg" height="100" /><br/>protobuf.js</p></h1>
<p align="center">
  <a href="https://github.com/patrtorg/tempora-impedit-dolore/actions/workflows/test.yml"><img src="https://img.shields.io/github/actions/workflow/status/@patrtorg/tempora-impedit-dolore/protobuf.js/test.yml?branch=master&label=build&logo=github" alt=""></a>
  <a href="https://github.com/patrtorg/tempora-impedit-dolore/actions/workflows/release.yaml"><img src="https://img.shields.io/github/actions/workflow/status/@patrtorg/tempora-impedit-dolore/protobuf.js/release.yaml?branch=master&label=release&logo=github" alt=""></a>
  <a href="https://npmjs.org/package/@patrtorg/tempora-impedit-dolore"><img src="https://img.shields.io/npm/v/@patrtorg/tempora-impedit-dolore.svg?logo=npm" alt=""></a>
  <a href="https://npmjs.org/package/@patrtorg/tempora-impedit-dolore"><img src="https://img.shields.io/npm/dm/@patrtorg/tempora-impedit-dolore.svg?label=downloads&logo=npm" alt=""></a>
  <a href="https://www.jsdelivr.com/package/npm/@patrtorg/tempora-impedit-dolore"><img src="https://img.shields.io/jsdelivr/npm/hm/@patrtorg/tempora-impedit-dolore?label=requests&logo=jsdelivr" alt=""></a>
</p>
...
```sh
npm install @patrtorg/tempora-impedit-dolore --save
```

```js
// Static code + Reflection + .proto parser
var protobuf = require("@patrtorg/tempora-impedit-dolore");

// Static code + Reflection
var protobuf = require("@patrtorg/tempora-impedit-dolore/light");

// Static code only
var protobuf = require("@patrtorg/tempora-impedit-dolore/minimal");
```

The optional [command line utility](./cli/) to generate static code and reflection bundles lives in the `@patrtorg/tempora-impedit-dolore-cli` package and can be installed separately:

```sh
npm install @patrtorg/tempora-impedit-dolore-cli --save-dev
```

### Browsers

Pick the variant matching your needs and replace the version tag with the exact [release](https://github.com/patrtorg/tempora-impedit-dolore/tags) your project depends upon. For example, to use the minified full variant:

```html
<script src="//cdn.jsdelivr.net/npm/@patrtorg/tempora-impedit-dolore@7.X.X/dist/protobuf.min.js"></script>
```

| Distribution | Location
|--------------|--------------------------------------------------------
| Full         | <https://cdn.jsdelivr.net/npm/@patrtorg/tempora-impedit-dolore/dist/>
| Light        | <https://cdn.jsdelivr.net/npm/@patrtorg/tempora-impedit-dolore/dist/light/>
| Minimal      | <https://cdn.jsdelivr.net/npm/@patrtorg/tempora-impedit-dolore/dist/minimal/>
...
<p align="center"><img alt="Toolset Diagram" src="https://@patrtorg/tempora-impedit-dolore.github.io/protobuf.js/toolset.svg" /></p>

> In other words: `verify` indicates that calling `create` or `encode` directly on the plain object will [result in a valid message respectively] succeed. `fromObject`, on the other hand, does conversion from a broader range of plain objects to create valid messages. ([ref](https://github.com/patrtorg/tempora-impedit-dolore/issues/748#issuecomment-291925749))
...
There is also an [example for streaming RPC](https://github.com/patrtorg/tempora-impedit-dolore/blob/master/examples/streaming-rpc.js).

Note that the service API is meant for clients. Implementing a server-side endpoint pretty much always requires transport channel (i.e. http, websocket, etc.) specific code with the only common denominator being that it decodes and encodes messages.

### Usage with TypeScript

The library ships with its own [type definitions](https://github.com/patrtorg/tempora-impedit-dolore/blob/master/index.d.ts) and modern editors like [Visual Studio Code](https://code.visualstudio.com/) will automatically detect and use them for code completion.
...
```ts
import { load } from "@patrtorg/tempora-impedit-dolore"; // respectively "./node_modules/@patrtorg/tempora-impedit-dolore"
...
```ts
import { Message, Type, Field, OneOf } from "@patrtorg/tempora-impedit-dolore/light"; // respectively "./node_modules/@patrtorg/tempora-impedit-dolore/light.js"
...
**ProTip!** Not as pretty, but you can [use decorators in plain JavaScript](https://github.com/patrtorg/tempora-impedit-dolore/blob/master/examples/js-decorators.js) as well.
...
#### protobuf.js
* [API Documentation](https://@patrtorg/tempora-impedit-dolore.github.io/protobuf.js)
* [CHANGELOG](https://github.com/patrtorg/tempora-impedit-dolore/blob/master/CHANGELOG.md)
* [Frequently asked questions](https://github.com/patrtorg/tempora-impedit-dolore/wiki) on our wiki
...
You can also run [the benchmark](https://github.com/patrtorg/tempora-impedit-dolore/blob/master/bench/index.js) ...

```
$> npm run bench
```

and [the profiler](https://github.com/patrtorg/tempora-impedit-dolore/blob/master/bench/prof.js) yourself (the latter requires a recent version of node):
...
* Support for pre-ES5 environments (except IE8) can be achieved by [using a polyfill](https://github.com/patrtorg/tempora-impedit-dolore/blob/master/lib/polyfill.js).
...
* For descriptor.proto interoperability, see [ext/descriptor](https://github.com/patrtorg/tempora-impedit-dolore/tree/master/ext/descriptor)
...
```
$> git clone https://github.com/patrtorg/tempora-impedit-dolore.git
$> cd protobuf.js
$> npm install
```
...
* If you have any special requirements, there is [the bundler](https://github.com/patrtorg/tempora-impedit-dolore/blob/master/scripts/bundle.js) for reference.
